...
?>
    ...
    <link rel="stylesheet" type="text/css" href="css/admin_style.css"> <!-- Ajout du CSS spécifique -->
</head>
<body>
    <?php
        if(!isset($_SESSION)){
        ...
        <div class="rightColumn">
            ...
            <div class="admin-container">
                <div class="admin-card">
                    <h2 class="admin-title"><?php echo $htmlEnvoyerMessageATousProducteurs; ?></h2>
                    <form action="traitements/traitement_broadcast_prod.php" method="post">
                        ...
                        <br>
                        <input type="submit" value="<?php echo $htmlEnvoyerMessageATousProducteurs; ?>" class="admin-button">
                    </form>
                </div>
            </div>
